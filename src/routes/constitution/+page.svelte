...
<div class="constitution">
    <h1 class="noUnderscore">FANTASY LEAGUE CONSTITUTION</h1>
    ...
    <p>1 IR Spots (Player must be labeled as IR, Out, or Covid in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>QB</td><td class="right">5 total</td></tr>
                <tr><td>RB</td><td class="right">6</td></tr>
                <tr><td>WR</td><td class="right">6</td></tr>
                <tr><td>TE</td><td class="right">5</td></tr>
                <tr><td>DL</td><td class="right">3</td></tr>
                <tr><td>LB</td><td class="right">3</td></tr>
                <tr><td>CB</td><td class="right">3</td></tr>
            </table>
        </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $1500. $50 bids are lowest bids allowed. Bids will process Thursdays and Sundays at 9AM EST.</p>
    ...
    <p>The draft order each year will be decided by a random means of the commissioners or leagues choosing.</p>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical 1.0PPR Scoring). The scoring system will never change without a majority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 7 teams will make the playoffs. The first round of playoffs will commence in week 15. Each team that wins their division and the wild card teams that finish with the best records, will receive a playoff berth. The team that has the best record in the league will receive a bye week. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>When a manager needs to be replaced, the commissioners will try to find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who are eager and will be very active within the league.</p>
    ...
    <p>League dues are set at {dues}$. Dues are collected through <a href="https://www.leaguesafe.com/league/4082539">LeagueSafe</a> and collection will be sent out no later than the first of August. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a penalty will be added to their payment and will go towards the payouts at the end of the year.</p>
